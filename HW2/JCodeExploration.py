...
# print('Provider FA0001387001 & FA1389001 appears to have a higher than expected amount of unpaid claims, ')
# print('although the reason cannot be determined from the available data')
...
# print('Specifically, FA0001387001 & FA1389001 as they appear to fail to pay out on the majority of their claims,')
# print('while also having the highest 2 of the highest volumes of claims.')
...
# print('Although, understanding all the additional confounding factors that may contribute to an unpaid claim')
# print('is would be important to determine how concerning these volumes of unpaid claims are.')
...
oneHotEncode = preprocessing.OneHotEncoder(categories='auto')
...
clf = RandomForestClassifier(n_estimators=25, max_depth = 10, min_samples_leaf = 3, n_jobs = -1)
...
def takeSecond(elem):
    return elem[1]
feature_importance = list(zip(featureNames,clf.feature_importances_))
